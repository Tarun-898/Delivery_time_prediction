...
class FeatureEngineering(BaseEstimator, TransformerMixin):
    ...
    def transform_data(self, df):
        ...
        try:
            ...
            if (
                "Restaurant_latitude" in df.columns
                and "Restaurant_longitude" in df.columns
                and "Delivery_location_latitude" in df.columns
                and "Delivery_location_longitude" in df.columns
            ):
...
class DataTransformation:
    ...
    def initate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_obj(
                file_path=self.data_transformation_config.process_obj_file_path,
                obj=process_obj,
            )
            save_obj(
                file_path=self.data_transformation_config.feature_engi_obj_path,
                obj=fe_obj,
            )
            ...
            return (
                train_arr,
                test_arr,
                self.data_transformation_config.process_obj_file_path,
            )
